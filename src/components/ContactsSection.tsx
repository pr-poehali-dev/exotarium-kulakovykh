  ...
  return (
    ...
    >
      ...
      >
        ...
        {isPrivacy ? (
          <>
            <h2 className="font-cormorant text-2xl font-bold mb-5 text-white">Политика конфиденциальности</h2>
            <div className="text-sm space-y-4" style={{ color: "hsla(45,30%,92%,0.65)" }}>
          ...
          <>
            <h2 className="font-cormorant text-2xl font-bold mb-5 text-white">Согласие на обработку персональных данных</h2>
            <div className="text-sm space-y-4" style={{ color: "hsla(45,30%,92%,0.65)" }}>
...
export default function ContactsSection() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="rounded-2xl p-8" style={{ background: "hsl(150,30%,10%)", border: "1px solid hsl(150,25%,18%)" }}>
              ...
              <p className="text-sm mb-6" style={{ color: "hsla(45,30%,92%,0.55)" }}>
              ...
              {formState === "success" ? (
                <div className="flex flex-col items-center justify-center py-10 gap-4 text-center">
                  ...
                  <p className="text-sm" style={{ color: "hsla(45,30%,92%,0.55)" }}>
                    ...
                    <div className="relative flex-shrink-0 mt-0.5">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          border: `1px solid ${agreed ? "hsl(142,60%,42%)" : "hsl(150,25%,22%)"}`,
                        }}
                      >
                        {agreed && <Icon name="Check" size={12} style={{ color: "#fff" }} />}
                      </div>
                    </div>
                    <span className="text-xs leading-relaxed" style={{ color: "hsla(45,30%,92%,0.55)" }}>
                      Я соглашаюсь с{" "}
      ...
      {/* FOOTER */}
      <footer style={{ background: "hsl(150,40%,4%)", borderTop: "1px solid hsl(150,25%,18%)" }}>
